...
export function NavBar(){
  ...
  <S.Wrapper >
    ...
    <S.Wrapper_Icon onPress={handleAssuntocreen}><S.Icon_Home source={require('../../../public/assets/Assunto_Fill.png')}/></S.Wrapper_Icon>
    <S.Wrapper_Icon onPress={handleForumscreen}><S.Icon_Home source={require('../../../public/assets/Forum_noFill.png')}/></S.Wrapper_Icon>
    <S.Wrapper_Icon onPress={handlePerfilscreen}><S.Icon_Home source={require('../../../public/assets/Perfil_noFill.png')}/></S.Wrapper_Icon>
  </S.Wrapper>
);
}
